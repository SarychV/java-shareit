...
public class ItemController {
    ...
    @PostMapping
    public ItemWithRequestIdDto createItem(@RequestHeader(HEADER_USER_ID) Integer ownerId,
    ...
    @PatchMapping("/{itemId}")
    public ItemDto updateItem(@RequestHeader(HEADER_USER_ID) Integer ownerId,
                              @RequestBody ItemDto itemDto, @PathVariable Long itemId) {
        return itemService.updateItem(itemId, itemDto, ownerId);
    }

    @GetMapping("/{itemId}")
    public ItemDtoExtended getItem(@RequestHeader(HEADER_USER_ID) Integer userId,
                                   @PathVariable Long itemId) {
