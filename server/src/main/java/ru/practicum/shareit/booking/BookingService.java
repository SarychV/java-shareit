...
public class BookingService {
    ...
    public List<BookingDtoOut> getPageByBooker(Integer bookerId, Integer from, Integer size, String stateParam) {
    ...
    public List<BookingDtoOut> getPageByOwner(Integer ownerId, Integer from, Integer size, String stateParam) {
        Page<Booking> bookings;
        StateStatus state = getStateStatus(stateParam);
