...
class BookingServiceTest {
    ...
    void getAllByBooker_whenStateAll_thenReturnRelevantPageOfBookings() {
        ...
        List<BookingDtoOut> result = service.getAllByBooker(bookerId, from, size, stateParam);
    ...
    void getAllByBooker_whenUserNotFound_thenThrowException() {
        ...
        assertThrows(NotFoundException.class, () -> service.getAllByBooker(bookerId, from, size, stateParam));
    }
    ...
    void getAllByOwner_whenStateAll_thenReturnRelevantPageOfBookings() {
        ...
        List<BookingDtoOut> result = service.getAllByOwner(ownerId, from, size, stateParam);
    ...
    void getAllByOwner_whenUserNotFound_thenThrowException() {
        ...
        assertThrows(NotFoundException.class, () -> service.getAllByOwner(ownerId, from, size, stateParam));
    }
